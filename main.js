...
fibonacciNumbers.push("cat");
fibonacciNumbers.unshift("big bird");
fibonacciNumbers.unshift("donkey")
...
dinosaurs.splice(5, 1);
let dinosaur2 = dinosaurs;

for (let i = 0; i < dinosaur2.length; i++) {
  const currentDino = dinosaur2[i];
...
// Challenge 13 Code
let dinoStar = dinosaurs.join("*");
console.log(dinoStar);
...
// Challenge 14 Code
console.log(`not reversed:▶︎ ${dinosaurs}`);
let reverseDino = dinosaurs.reverse();
console.log(`reversed:▶︎ ${reverseDino}`);
...
for (let i = 0; i < arr3.length; i++) {
  const currentItem = arr3[i];
  console.log(currentItem);
}
console.log(`this is arr1:▶︎ ${arr1}`);
console.log(`this is arr2:▶︎ ${arr2}`);
//end